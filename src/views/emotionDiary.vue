            ...
            <div class="diary-card">
             ...
             <!-- 详情记录 -->
              <div class="diary-card">
                ...
                <!-- 修复：dotail-form -> detail-form -->
                <div class="detail-form">
                    <!-- 修复：form-froup -> form-group -->
                    <div class="form-group">
                        <div class="form-label">主要情绪触发因素</div>
                        <el-input v-model="diaryForm.emotionTriggers" placeholder="今天什么事情导致了你的主要情绪？" type="textarea" :rows="3" maxLength="1000" show-word-limit></el-input>
                    </div>
                    <div class="form-group">
                        <div class="form-label">今日感想</div>
                        <el-input v-model="diaryForm.diaryContent" placeholder="写下您今天的想法，感受或发生的事情..." type="textarea" :rows="5" maxLength="2000" show-word-limit></el-input>
                    </div>
                    ...
                    <!-- 生活指标 -->
                     ...
                     <!-- 修复：补充了按钮，并修正了类名 action-buttons -->
...
// 修复：将 selectedEmotion 改为 selectEmotion，与模板对应
        ...
        .diary-card {
            ...
            .detail-form {
                ...
                .action-buttons {
                    margin-top: 40px;
                    display: flex;
                    justify-content: flex-end; /* 按钮居右，如果你想居中可以改成 center */
                    gap: 15px;
                }
            }
        }
